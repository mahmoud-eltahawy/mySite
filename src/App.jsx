...
import { BooringCv } from "./BooringCv";
...
function App() {
  return (
    <Router>
      ...
      <Route path="/cv" component={BooringCv}/>
    </Router>
  );
}
...
function Home(){
  ...
  typist.type("Formal Cv",set_cv)
  
  return (
    <section class="grid grid-cols-1 justify-center bg-cyan-950 text-lime-400 m-10">
      ...
      <a href="/cv" class="h-56 w-[100%] text-5xl sm:text-7xl grid grid-cols-1 gap-4 place-content-center place-items-center m-5 border-cyan-400 border-2 rounded-xl">{cv()}</a>
    </section>
